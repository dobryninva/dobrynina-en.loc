mvtSeoData.window.CreateCommonTemplate = function (config) {
    config = config || {};
    if (!config.id) {
        config.id = 'mvtseodata-common-template-window-create';
    }
    Ext.applyIf(config, {
        title: _('mvtseodata_template_create'),
        width: 1050,
        autoHeight: true,
    ...
    mvtSeoData.window.CreateCommonTemplate.superclass.constructor.call(this, config);
};
Ext.extend(mvtSeoData.window.CreateCommonTemplate, MODx.Window, {
            ...
            items: [{
                ...
                items: [{
                        ...
                        items: [{
                                ...
                                layout: 'form',
                                items: [{
                                        xtype: 'mvtseodata-combo-resource-class-key',
                                        fieldLabel: _('mvtseodata_resource_class_key'),
                                        name: 'resource_class_key',
                                        id: config.id + '-resource_class_key',
                                        hiddenName: 'resource_class_key',
                                        anchor: '99%',
                                        allowBlank: false
                                }]
                        }]
                        ...
                        items: [{
                                ...
                                items: [{
                                       xtype: 'mvtseodata-combo-link-resource',
                                        fieldLabel: _('mvtseodata_assortment_resource_parent'),
                                        name: 'resource_parent_id',
                                        id: config.id + '-resource_parent_id',
                                        anchor: '99%',
                                        allowBlank: false
                                }]
                        } , {
                                ...
                                items: [{
                                        xtype: 'numberfield',
                                        fieldLabel: _('mvtseodata_priority'),
                                        name: 'priority',
...
Ext.reg('mvtseodata-common-template-window-create', mvtSeoData.window.CreateCommonTemplate);


mvtSeoData.window.UpdateCommonTemplate = function (config) {
    config = config || {};
    if (!config.id) {
        config.id = 'mvtseodata-common-template-window-update';
    }
    Ext.applyIf(config, {
        title: _('mvtseodata_template_update'),
        width: 1050,
        autoHeight: true,
        url: mvtSeoData.config.connector_url,
    ...
    mvtSeoData.window.UpdateCommonTemplate.superclass.constructor.call(this, config);
};
Ext.extend(mvtSeoData.window.UpdateCommonTemplate, MODx.Window, {
...
Ext.reg('mvtseodata-common-template-window-update', mvtSeoData.window.UpdateCommonTemplate);