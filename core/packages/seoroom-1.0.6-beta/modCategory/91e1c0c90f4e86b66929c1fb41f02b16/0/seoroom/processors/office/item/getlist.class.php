 ...
 * Get a list of Items
 */
class SEOroomOfficeItemGetListProcessor extends modObjectGetListProcessor {
	...
	public function prepareRow(xPDOObject $object) {
		...
		if (!$array['active']) {
			$array['actions'][] = array(
				...
				'title' => $this->modx->lexicon('seoroom_item_enable'),
				'multiple' => $this->modx->lexicon('seoroom_items_enable'),
				'action' => 'enableItem',
				'button' => true,
				'menu' => true,
			);
			...
			$array['actions'][] = array(
				...
				'title' => $this->modx->lexicon('seoroom_item_disable'),
				'multiple' => $this->modx->lexicon('seoroom_items_disable'),
				'action' => 'disableItem',
				'button' => true,
				'menu' => true,
			);
...
return 'SEOroomOfficeItemGetListProcessor';