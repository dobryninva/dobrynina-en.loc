...
$_lang['moddevtools_elements_found'] = 'Найдено элементов: ';
$_lang['moddevtools_collapse_expand'] = 'Свернуть/развернуть все';
...
$_lang['area_moddevtools_main'] = 'Основные';
$_lang['setting_moddevtools_virtual_chunks'] = 'Показывать виртуальные чанки';
$_lang['setting_moddevtools_virtual_chunks_desc'] = 'Включите, если хотите, чтобы чанки создавались автоматически';
$_lang['setting_moddevtools_debug'] = 'Включить Debug';
$_lang['setting_moddevtools_debug_desc'] = 'Выводить информацию о работе плагина в логе ошибок';