...
class modDevToolsSearchProcessor extends modProcessor {
    public $map = array(
        'modChunk' => array('name' => 'name', 'content' => 'snippet', 'element' => 'element/chunk'),
        'modTemplate' => array('name' => 'templatename', 'content' => 'content', 'element' => 'element/template'),
        'modResource' => array('name' => 'pagetitle', 'content' => 'content', 'element' => 'resource'),
    );
    ...
    public function getElements($class) {
        ...
        foreach ($elements as $element) {
            ...
            $data[] = array(
                ...
                'class' => $class,
                'element' => $this->map[$class]['element'],
