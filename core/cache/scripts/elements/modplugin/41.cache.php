<?php  return '$seoTemplates = $modx->getService(\'seotemplates\',\'seoTemplates\',$modx->getOption(\'seotemplates_core_path\',null,$modx->getOption(\'core_path\').\'components/seotemplates/\').\'model/seotemplates/\', array());
