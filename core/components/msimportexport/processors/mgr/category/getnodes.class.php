...
class msImportExportGetNodesProcessor extends modResourceGetNodesProcessor
{
    protected $pid;
    protected $parent_id;
    ...
    public function initialize()
    {
        ...
        $this->categories = array_map('trim', explode(',', $parents));
...
return 'msImportExportGetNodesProcessor';