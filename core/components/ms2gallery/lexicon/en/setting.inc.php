...
$_lang['ms2gallery_source_maxUploadWidth_desc'] = 'Maximum width of image for upload. All images, that exceeds this parameter, will be resized to fit. Specify 0 to disable it.';
$_lang['ms2gallery_source_maxUploadHeight_desc'] = 'Maximum height of image for upload. All images, that exceeds this parameter, will be resized to fit. Specify 0 to disable it.';
$_lang['ms2gallery_source_maxUploadSize_desc'] = 'Maximum size of file for upload (in bytes). No limit by default.';
