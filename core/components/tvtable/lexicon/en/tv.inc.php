...
$_lang['tvtable.headers_desc'] = 'List of column headings (separate headings with ||, e.g. Name||Price)';
$_lang['tvtable.headers_default'] = 'Default heading';
$_lang['tvtable.headers_default_desc'] = 'Optional. This value will be displayed for empty headers.';
