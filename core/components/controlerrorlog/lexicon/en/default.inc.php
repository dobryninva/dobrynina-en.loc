...
$_lang['errorlog_total_messages'] = 'Total: ';
...
$_lang['errorlog_web_too_large'] = '<h3>The error log is too large to be viewed.</h3>';
$_lang['errorlog_web_last_lines'] = '<h4>The last [[+last]] lines.</h4>';