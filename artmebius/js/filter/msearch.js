...
var mSearch2 = {
    ...
    options: {
        ...
        prefix: 'mse2_',
        suggestion: '.filter_item_label_sup', // inside filter item, e.g. #mse2_filters
        autoLoad: true,
    },
    sliders: {},
    numbers: {},
    ...
    handlePagination: function () {
        ...
        switch (mse2Config['mode']) {
            ...
            case 'scroll':
                this.pagination.hide();
                var wrapper = $(this.options['results']); // wrapper
                var $window = $(window);
    ...
    beforeLoad: function () {
        ...
        this.results.addClass(this.options['loading_class']).css('opacity', .5);
    ...
    afterLoad: function () {
        ...
        this.results.removeClass(this.options['loading_class']).css('opacity', 1);
                ...
                source: function (request, callback) {
                    ...
                    $.post(mse2Config['actionUrl'], data, function (response) {
                        ...
                        let more = {
                          ...
                          url: 'search.html',
                          value: request.term,
                          label:'<div class="search_tip"><a class="search_tip_link search_tip_more" href="/search.html">Показать все результаты</a></div>'
                        };
                        if (response['data']['total'] > 4) {
                          response['data']['results'].push(more);
                        }
