...
$modx->toPlaceholders($scriptProperties);
...
//Устанавливаем плейсхолдеры tv-параметрам со значениями
$props = $getProducts->config['includeTVList'];
$props = explode(',', $props);
...
foreach($active_props as $key => $prop){
  $modx->setPlaceholder('ph_'.$prop, 1);
}
