...
<div class="tiles_col col-auto">
  <div class="prds_item ms2_product shk-item" data-id="{$id}">
    <div class="prds_item_top">
      ...
      <div class="prds_item_title">
        <a class="prds_item_title_link prds_item_link" href="{$id | url}" {$link_attributes}>
          <span class="prds_item_title_link_image">
            <img class="prds_item_img" src="{$image | phpthumbon : $img_params}" alt="{$pagetitle | clean : 'qq'}" />
          </span>
          <span class="prds_item_title_link_text">{$menutitle ?: $pagetitle}</span>
        </a>
      </div>

    </div>
    <div class="prds_item_btm">
      ...
      <div class="prds_item_available {($availability in list [1, 'true']) ? 'available_yes' : 'available_no'}">
